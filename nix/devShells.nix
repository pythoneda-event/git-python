rec {
  shellHook-for = { package, pythoneda-base, python, nixpkgsRelease }: ''
    ...
    echo -e " \033[32m| '_ \| | | | __| '_ \ / _ \| '_ \ \033[34m/ _ \\\\\033[35m/ _\` |\033[36m/ _\` |\033[34mhttps://github.com/pythoneda-event/git-python/tree/$PVERSION\033[0m";
    echo -e " \033[32m| |_) | |_| | |_| | | | (_) | | | |\033[34m  __/\033[35m (_| |\033[36m (_| |\033[35mhttps://github.com/pythoneda/git-python\033[0m";
    ...
    echo -e " \033[32m|_| \033[31mD\033[36mE\033[32m |___/            \033[33mGIT-PYTHON EVENTS\033[0m";
    echo;
